      ...
      <div className="container max-w-none lg:w-full">
        <div className='md:flex items-center'>
          <div className="md:w-[678px] z-10">
            <div className="text-sm inline-flex border border-[#222]/10 px-3 py-1 rounded-lg tracking-tight"> Version 2.0 is here
            </div>
          ...
          <div className="mt-20 md:mt-0 md:h-[648px] md:flex-1 relative ">
            <Image src={cogImage} alt="Cog image" className="md:absolute md:h-full md:w-auto md:max-w-none lg:-right-6 z-0" />
            <Image src={cylinderImage} width={220} height={220} alt="Cylinder image" className="hidden lg:block -top-8 lg:left-1- md:absolute" />
            <Image src={noodleImage} width={220} alt="Noodle image" className="hidden lg:block absolute top-[544px] -right-8 rotate-[30deg]" />
          </div>
        </div>
      </div>
    </section>
